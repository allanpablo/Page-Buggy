...
<head>
  ...
  <meta content="Passeio de Buggy Em Natal, litoral norte, litoral sul, pipa, maracajau e muito mais..." name="description">
...
<body>
    ...
    <div id="heroCarousel" class="container carousel carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          ...
          <p class="animate__animated animate__fadeInUp">Natal é conhecida pelas extensas dunas de areia costeiras e pelo Forte dos Reis Magos, em forma de estrela, uma fortaleza portuguesa do século XVI na foz do rio Potengi. A norte do rio, Genipabu é uma área de enormes dunas com uma lagoa de água doce. A autoestrada Via Costeira liga uma faixa de 15 km de praias a sul do forte.</p>
          <a href="http://turismo.natal.rn.gov.br/" class="btn-get-started animate__animated animate__fadeInUp scrollto">Leia Mais Sobre Natal</a>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          ...
          <p class="animate__animated animate__fadeInUp">Criamos um pacote com os melhores passeios para te proporcionar a melhor experiencia em passeios turisticos.</p>
          <a href="https://www.instagram.com/dannyel_bugueiro" class="btn-get-started animate__animated animate__fadeInUp scrollto">Acompanhe nossas histórias</a>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          ...
          <p class="animate__animated animate__fadeInUp">Chama os Amigos e vem passear em Natal com o Melhor Bugueiro e Guia de Turismo de Natal. Estamos prontos para receber você e sua família.</p>
          <a href="https://api.whatsapp.com/send?phone=5584999690550" class="btn-get-started animate__animated animate__fadeInUp scrollto">Entre em Contato</a>
        </div>
      </div>
  ...
  <svg class="hero-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#F2C572" fill-opacity="1" d="M0,128L80,122.7C160,117,320,107,480,112C640,117,800,139,960,149.3C1120,160,1280,160,1360,160L1440,160L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path></svg>
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row content" data-aos="fade-up">
          <div class="col-lg-6">
            <p>
              Meu Nome é Dannyel Almeida, Bugueiro credenciado e Guia de Turismo. De Buggy , Carro executivo, 4x4 com ou sem adrenalina, quero te proporcionar a melhor experiência no RN.
            </p>
            <ul>
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p>
              ...
              <a class="cta-btn align-middle" href="https://api.whatsapp.com/send?phone=5584999690550"><i class="icofont-whatsapp"></i>Whatsapp</a>
    ...
    <section id="features" class="features">
      <div class="container">
        <div class="section-title" data-aos="zoom-out">
          <h2>VIAGENS</h2>
          <p>Alguma de nossas viagens</p>
        </div>
        <ul class="nav nav-tabs row d-flex">
          <li class="nav-item col-3" data-aos="zoom-in">
            <a class="nav-link active show" data-toggle="tab" href="#tab-1">
              <i class="icofont-direction-sign"></i>
              <h4 class="d-none d-lg-block">Litoral Sul</h4>
            </a>
          </li>
          <li class="nav-item col-3" data-aos="zoom-in" data-aos-delay="100">
            <a class="nav-link show" data-toggle="tab" href="#tab-2">
              <i class="icofont-direction-sign"></i>
              <h4 class="d-none d-lg-block">Lagoas Sul</h4>
            </a>
          </li>
          <li class="nav-item col-3" data-aos="zoom-in" data-aos-delay="200">
            <a class="nav-link  show" data-toggle="tab" href="#tab-3">
              <i class="icofont-direction-sign"></i>
              <h4 class="d-none d-lg-block">Litoral Sul</h4>
            </a>
          </li>
          <li class="nav-item col-3" data-aos="zoom-in" data-aos-delay="300">
            <a class="nav-link show" data-toggle="tab" href="#tab-4">
              <i class="icofont-direction-sign"></i>
              <h4 class="d-none d-lg-block">Premium + Por do Sol</h4>
            </a>
          </li>
        </ul>
        ...
        <div class="tab-content" data-aos="fade-up">
          <div class="tab-pane active show" id="tab-1">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;Neste maravilhoso passeio será visitado em média 15 praias, 02 lagoas e 01 parque de duna.
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="assets/img/portfolio/ls1.jpeg" alt="" class="img-fluid">
                  <BR>
                  <BR>
                <a href="lits-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i>Clique Aqui Para Mais Detalhes</a>
              </div>
            </div>
          </div>
          <div class="tab-pane" id="tab-2">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="assets/img/portfolio/lagoas.jpeg" alt="" class="img-fluid">
                  <BR>
                  <BR>
                <a href="lags-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i>Clique Aqui Para Mais Detalhes</a>
              </div>
            </div>
          </div>
          <div class="tab-pane" id="tab-3">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;O passeio mais tradicional da cidade. Alegria, diversão e emoção andam juntos. Se vim a Natal, fazer este passeio é obrigatório!
                </p>
                  <ul>
                      <li><i class="icofont-beach"></i> Praia de Ponta Negra;</li>
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="assets/img/portfolio/lits.jpeg" alt="" class="img-fluid">
                  <BR>
                  <BR>
                <a href="lits-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i>Clique Aqui Para Mais Detalhes</a>
              </div>
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="assets/img/portfolio/dunna.jpeg" alt="" class="img-fluid">
                  <BR>
                  <BR>
                <a href="lnp-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i>Clique Aqui Para Mais Detalhes</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="section-title" data-aos="zoom-out">
          ...
          <h5>Clique nas fotos para Zoom e Detalhe das viagens</h5>
        </div>

        <ul id="portfolio-flters" class="d-flex justify-content-end" data-aos="fade-up">
          <li data-filter="*" class="filter-active">Todas</li>
          <li data-filter=".filter-LITS">Litoral Sul</li>
          <li data-filter=".filter-LAGS">Lagoas Sul</li>
          <li data-filter=".filter-LITN">Litoral Norte</li>
          <li data-filter=".filter-LNP">Litoral Norte Premium + Por do Sol</li>
        </ul>

        <div class="row portfolio-container" data-aos="fade-up">

          <div class="col-lg-4 col-md-6 portfolio-item filter-LITS">
            <div class="portfolio-img"><img src="assets/img/portfolio/balsa.jpeg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Litoral Sul</h4>
              <p>Balsa</p>
              <a href="assets/img/portfolio/balsa.jpeg" data-gall="portfolioGallery" class="venobox preview-link" title="Litoral Sul"><i class="icofont-ui-zoom-in"></i></a>
              <a href="lits-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-LAGS">
            <div class="portfolio-img"><img src="assets/img/portfolio/lagoas.jpeg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Lagoa Sul</h4>
              <p>Lagoa de Arituba</p>
              <a href="assets/img/portfolio/lagoas.jpeg" data-gall="portfolioGallery" class="venobox preview-link" title="Lagoa Sul"><i class="icofont-ui-zoom-in"></i></a>
              <a href="lags-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-LNP">
            <div class="portfolio-img"><img src="assets/img/portfolio/pordosol1.jpeg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Litoral Norte Premium</h4>
              <p>Por do Sol</p>
              <a href="assets/img/portfolio/pordosol1.jpeg" data-gall="portfolioGallery" class="venobox preview-link" title="Litoral Norte Premium"><i class="icofont-ui-zoom-in"></i></a>
              <a href="lnp-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-LITN">
            <div class="portfolio-img"><img src="assets/img/portfolio/dunna1.jpeg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Litoral Norte</h4>
              <p>Dunas</p>
              <a href="assets/img/portfolio/dunna1.jpeg" data-gall="portfolioGallery" class="venobox preview-link" title="Litoral Norte"><i class="icofont-ui-zoom-in"></i></a>
              <a href="litn-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-LITS">
            <div class="portfolio-img"><img src="assets/img/portfolio/pipa.jpeg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Litoral Sul</h4>
              <p>Pipa</p>
              <a href="assets/img/portfolio/pipa.jpeg" data-gall="portfolioGallery" class="venobox preview-link" title="Litoral Sul"><i class="icofont-ui-zoom-in"></i></a>
              <a href="lits-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-LAGS">
            <div class="portfolio-img"><img src="assets/img/portfolio/lagoas3.jpeg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Lagoas Sul</h4>
              <p>Passeio</p>
              <a href="assets/img/portfolio/lagoas3.jpeg" data-gall="portfolioGallery" class="venobox preview-link" title="Lagoas Sul"><i class="icofont-ui-zoom-in"></i></a>
              <a href="lags-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-LITN">
            <div class="portfolio-img"><img src="assets/img/portfolio/ln.jpeg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Litoral Norte</h4>
              <p>Lagoa</p>
              <a href="assets/img/portfolio/ln.jpeg" data-gall="portfolioGallery" class="venobox preview-link" title="Litoral Norte"><i class="icofont-ui-zoom-in"></i></a>
              <a href="litn-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-LNP">
            <div class="portfolio-img"><img src="assets/img/portfolio/12.jpeg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Litoral Norte</h4>
              <p>Quer Emoção?</p>
              <a href="assets/img/portfolio/12.jpeg" data-gall="portfolioGallery" class="venobox preview-link" title="Litoral Norte"><i class="icofont-ui-zoom-in"></i></a>
              <a href="lnp-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-LITS">
            <div class="portfolio-img"><img src="assets/img/portfolio/lits.jpeg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Litoral Sul</h4>
              <p>Praias Sul</p>
              <a href="assets/img/portfolio/lits.jpeg" data-gall="portfolioGallery" class="venobox preview-link" title="Litoral Sul"><i class="icofont-ui-zoom-in"></i></a>
              <a href="lits-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 portfolio-item filter-LAGS">
            <div class="portfolio-img"><img src="assets/img/portfolio/lagoa1.jpeg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Lagoas Sul</h4>
              <p>Extras</p>
              <a href="assets/img/portfolio/lagoa1.jpeg" data-gall="portfolioGallery" class="venobox preview-link" title="Lagoas Sul"><i class="icofont-ui-zoom-in"></i></a>
              <a href="lags-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i></a>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-LITN">
            <div class="portfolio-img"><img src="assets/img/portfolio/genipabu.jpeg" class="img-fluid" alt=""></div>
            <div class="portfolio-info">
              <h4>Litoral Norte</h4>
              <p>Praia Genipabu</p>
              <a href="assets/img/portfolio/genipabu.jpeg" data-gall="portfolioGallery" class="venobox preview-link" title="Litoral Norte"><i class="icofont-ui-zoom-in"></i></a>
              <a href="litn-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i></a>
            </div>
          </div>
            <div class="col-lg-4 col-md-6 portfolio-item filter-LNP">
                <div class="portfolio-img"><img src="assets/img/portfolio/11.jpeg" class="img-fluid" alt=""></div>
                <div class="portfolio-info">
                    <h4>Litoral Norte Premium</h4>
                    <p>Por do Sol</p>
                    <a href="assets/img/portfolio/11.jpeg" data-gall="portfolioGallery" class="venobox preview-link" title="Litoral Norte Premium"><i class="icofont-ui-zoom-in"></i></a>
                    <a href="lnp-details.php" class="details-link" title="More Details"><i class="icofont-tags"></i></a>
                </div>
            </div>
        </div>
      ...
      <div class="container">
        ...
        <ul class="faq-list">
          ...
          <li data-aos="fade-up" data-aos-delay="100">
            <a data-toggle="collapse" class="" href="#faq1">Quanto tempo dura o passeio? <i class="icofont-simple-up"></i></a>
          ...
          <li data-aos="fade-up" data-aos-delay="200">
            <a data-toggle="collapse" href="#faq2" class="collapsed">O que está incluso no valor do passeio? <i class="icofont-simple-up"></i></a>
          ...
          <li data-aos="fade-up" data-aos-delay="300">
            <a data-toggle="collapse" href="#faq3" class="collapsed">Eu vou dividir o buggy com outras pessoas? <i class="icofont-simple-up"></i></a>
            <div id="faq3" class="collapse" data-parent=".faq-list">
              <p>
                Depende da modalidade, no caso pode ser escolhido passeio privativo ou fechar todos os lugares com amigos e familia, caso contrario as demais vagas devem ser fechado com os demais.
              </p>
            </div>
          </li>

          <li data-aos="fade-up" data-aos-delay="400">
            <a data-toggle="collapse" href="#faq4" class="collapsed">Existe algum pacote de passeio turistico? <i class="icofont-simple-up"></i></a>
          ...
          <li data-aos="fade-up" data-aos-delay="600">
            <a data-toggle="collapse" href="#faq6" class="collapsed">Como funciona o passeio privativo? <i class="icofont-simple-up"></i></a>
...
-->
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="copyright">
        &copy; Copyright <strong><span>Passeio de Buggy com Dannyel Almeida</span></strong>. Todos os Direitos Reservados
      </div>
      <div class="credits">
