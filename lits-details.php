        ...
        <div class="portfolio-details-container" data-aos="fade-up">
          ...
          <div class="portfolio-info">
            ...
            <ul>
              ...
              <li><strong>Região</strong>: Litoral Sul</li>
              <li><strong>Duração Viagem</strong>: 06 - 07 Hs</li>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;Neste maravilhoso passeio será visitado em média 15 praias, 02 lagoas e 01 parque de duna.
            ...
            <div>
                <ul>
                  ...
                  <P>
                    <br>Dinheiro: R$550,00 
                    <br>Cartão até 12x sem juros: R$600,00
                    <br>Valores válidos 31/03/2021.
                  </P>
                </ul>
            </div>
